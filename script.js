...
fetch(apiUrl)
    ...
    .then(data => {
        ...
        document.getElementById("Fajr").textContent = timings.Fajr || "Not Available";
        document.getElementById("Dhuhr").textContent = timings.Dhuhr || "Not Available";
        document.getElementById("Asr").textContent = timings.Asr || "Not Available";
        document.getElementById("Maghrib").textContent = timings.Maghrib || "Not Available";
        document.getElementById("Isha").textContent = timings.Isha || "Not Available";
        ...
        const zawalDate = new Date(dhuhrDate.getTime() - 10 * 60 * 1000); // Subtract 10 minutes from Dhuhr
        const zawalTime = zawalDate.toLocaleTimeString('en-US', { hour: '2-digit', minute: '2-digit', hour12: true });

        // Calculate Second Third of the Night
        ...
        document.getElementById("sunrise").textContent = timings.Sunrise || "Not Available";
        document.getElementById("ishraq").textContent = ishraqTime || "Not Available";
        document.getElementById("chaasht").textContent = chaashtTime || "Not Available";
        document.getElementById("zawal").textContent = zawalTime || "Not Available";
